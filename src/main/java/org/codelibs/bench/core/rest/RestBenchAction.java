...
package org.codelibs.bench.core.rest;

import static org.elasticsearch.common.xcontent.json.JsonXContent.*;
...
import org.codelibs.bench.core.action.AbortBenchmarkRequest;
import org.codelibs.bench.core.action.AbortBenchmarkResponse;
import org.codelibs.bench.core.action.BenchmarkAction;
import org.codelibs.bench.core.action.BenchmarkCompetitorBuilder;
import org.codelibs.bench.core.action.BenchmarkRequest;
import org.codelibs.bench.core.action.BenchmarkRequestBuilder;
import org.codelibs.bench.core.action.BenchmarkResponse;
import org.codelibs.bench.core.action.BenchmarkSettings;
import org.codelibs.bench.core.action.BenchmarkStatusAction;
import org.codelibs.bench.core.action.BenchmarkStatusRequest;
import org.codelibs.bench.core.action.BenchmarkStatusResponse;
...
public class RestBenchAction extends BaseRestHandler {
    ...
    public RestBenchAction(Settings settings, Client client, RestController controller) {
        ...
        // Abort benchmark
        controller.registerHandler(POST, "/_xbench/abort/{name}", this);
    }
    ...
    private void handleStatusRequest(final RestRequest request, final RestChannel channel, final Client client) {
        ...
        client.execute(BenchmarkStatusAction.INSTANCE, benchmarkStatusRequest, new RestBuilderListener<BenchmarkStatusResponse>(channel) {
    ...
    private void handleAbortRequest(final RestRequest request, final RestChannel channel, final Client client) {
        ...
        client.execute(AbortBenchmarkAction.INSTANCE, abortBenchmarkRequest, new AcknowledgedRestListener<AbortBenchmarkResponse>(channel));
    }
    ...
    private void handleSubmitRequest(final RestRequest request, final RestChannel channel, final Client client) {
        ...
        client.execute(BenchmarkAction.INSTANCE, benchmarkRequest, new RestBuilderListener<BenchmarkResponse>(channel) {
